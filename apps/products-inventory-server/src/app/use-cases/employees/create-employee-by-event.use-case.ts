import { EmployeeAlreadyExistsError } from '@errors/models/employees/employee-already-exists.error'
...
> {
  ...
  protected async performOperation(
    ...
    if (foundEmployee !== null) return failure(new EmployeeAlreadyExistsError({ employee: { id: userID } }))
