import { EmployeeNotFoundError } from '@errors/models/employees/employee-not-found.error'
...
> {
  ...
  protected async performOperation(
    ...
    if (foundEmployee === null) return failure(new EmployeeNotFoundError({ employee: { id: userID } }))
