...
export namespace UpdateOrderAfterAwaitingPaymentOrdersRepositoryDTO {
...
export interface IUpdateOrderAfterAwaitingPaymentOrdersRepository {
  updateOrderAfterAwaitingPayment(
